                    ...
                    case Protocol.PROOM_IN: { // 입장한 사실을 알림
                        ...
                        for (TmtServerThread cst : tmtChatServer.globalList) {
                            if (otherName.equals(cst.talkName)) {// 상대에게 보내기
                                ...
                                // cst.send(Protocol.PROOM_IN + Protocol.separator + talkName +
                                // Protocol.separator
                                // + otherName
                                // + Protocol.separator + menu);
                                break;
                        ...
                        this.send(Protocol.PROOM_IN + Protocol.separator + talkName + Protocol.separator +
                                otherName
                                + Protocol.separator + menu);
                    }
                        break;
